...
const Hoodies = ({products}) => {
  return (
    <div>
      <Head>
        <title>Hoodies - Raj's wear</title>
        <meta
          name="viewport"
      ...
      <section className="text-gray-600 body-font justify-center min-h-screen">
        <div className="container  md:px-20 py-14 mx-auto justify-center">
          <div className="flex flex-wrap justify-center  ">
            {Object.keys(products).length ===0 && <p className="px-4">Sorry all the Hoodies are currently out of stock. New stock coming soon. Stay Tuned!.</p>}
