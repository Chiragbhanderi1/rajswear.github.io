      ...
      <section className="text-gray-600 body-font overflow-hidden min-h-screen">
        ...
        <div className="container px-5 py-6 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap ">
            <img
              alt="ecommerce"
              className="lg:w-1/3 p-2  h-[65vh]  object-top rounded shadow-lg "
              src={product.img}
            />
            ...
            <a className="text-gray-500">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex disabled:bg-purple-300 ml-8 text-white bg-purple-500 border-0 py-2 md:px-6 px-2 focus:outline-none hover:bg-purple-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  ...
                  className="flex disabled:bg-purple-300 ml-4 text-white bg-purple-500 border-0 py-2 md:px-6 px-2 focus:outline-none hover:bg-purple-600 rounded"
                >
                  Add to Cart
                </button>
            ...
            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                ...
                <button
                  ...
                  className="flex ml-14 text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded"
                >
                  Check
                </button>
              </div>
...
export async function getServerSideProps(context) {
  ...
  let colourSizeSlug = {}; // {red: {XL:{slug:'wear-the-comfort2'}}}
